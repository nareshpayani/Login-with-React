            ...
            <form onSubmit={this.handleSubmit} className="FormFields">
              ...
              <div className="FormField">
                <label className="FormField_CheckboxLabel">
                    <input className="FormField_Checkbox" type="checkbox" name="agreed" value={this.state.agreed} onChange={this.handleChange}  /> I agree all statements in <a href="" className="FormField__TermsLink">terms of service</a>
                </label>
              </div>

              <div className="FormField">
                  <button className="FormField_Button ">Sign Up</button> <Link to="/sign-in" className="FormField_Link">I'm already member</Link>
              </div>
            </form>
          </div>
        );
